      ...
      <main className="container">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          <div className="col-lg-6 px-0">
            <h1 className="display-4 fst-italic">Business Systems Analyst</h1>
            <p className="lead my-3">
              I have worked with developers and business stakeholders to deliver
              solutions that meet business needs. I have experience in the full
              software development lifecycle from requirements gathering to
              implementation and support. I have worked on projects in in-house
